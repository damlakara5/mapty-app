...
class App {
  ...
  constructor() {
    ...
    form.addEventListener('submit', this._newWorkout.bind(this)); //on method is coming from the leaflet library
  ...
  _showForm(mapE) {
    ...
    inputDistance.focus(); //for the cursor immidiately focus on input
  }
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Inputs have to be positive numbers!'); //guard
